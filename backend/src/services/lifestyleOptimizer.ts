...
const DEFAULT_ACTIONS = [
  // ── ENERGY (10 actions) ──────────────────────────────────
  {
    ...
    category: "energy",
    description:
      "Replace all incandescent/CFL bulbs with energy-efficient LEDs",
    icon: "💡",
    carbonSavedKg: 15,
    monthlySavings: 200,
    upfrontCost: 1500,
  ...
  },
  {
    ...
    category: "energy",
    description:
      "Set AC to 24°C instead of lower temperatures — each degree saves 6% energy",
    icon: "❄️",
    carbonSavedKg: 25,
    monthlySavings: 500,
    upfrontCost: 0,
  ...
  },
  {
    ...
    category: "energy",
    description:
      "Unplug chargers, TVs, and appliances when not in use to eliminate phantom load",
    icon: "🔌",
    carbonSavedKg: 8,
    monthlySavings: 150,
    upfrontCost: 0,
  ...
  },
  {
    ...
    category: "energy",
    description:
      "Install a solar water heater to eliminate gas/electric water heating",
    icon: "☀️",
    carbonSavedKg: 50,
    monthlySavings: 800,
    upfrontCost: 15000,
  ...
  },
  {
    ...
    category: "energy",
    description:
      "Open windows for cross-ventilation instead of using AC during mild weather",
    icon: "🪟",
    carbonSavedKg: 20,
    monthlySavings: 400,
    upfrontCost: 0,
  ...
  },
  {
    ...
    category: "energy",
    description:
      "Generate your own clean electricity with rooftop solar installation",
    icon: "🔆",
    carbonSavedKg: 150,
    monthlySavings: 2000,
    upfrontCost: 80000,
  ...
  },
  {
    ...
    category: "energy",
    description:
      "Replace old appliances with BEE 5-star rated models when upgrading",
    icon: "⭐",
    carbonSavedKg: 35,
    monthlySavings: 500,
    upfrontCost: 5000,
  ...
  // ── TRANSPORT (7 actions) ────────────────────────────────
  {
    ...
    category: "transport",
    description:
      "Use public transport for your daily commute instead of private vehicle",
    icon: "🚌",
    carbonSavedKg: 80,
    monthlySavings: 2000,
    upfrontCost: 0,
  ...
  },
  {
    ...
    category: "transport",
    description:
      "Share your commute with colleagues or neighbors going the same way",
    icon: "🚗",
    carbonSavedKg: 50,
    monthlySavings: 1500,
    upfrontCost: 0,
  ...
  },
  {
    ...
    category: "transport",
    description:
      "Replace petrol/diesel vehicle with an electric vehicle for daily commute",
    icon: "⚡",
    carbonSavedKg: 120,
    monthlySavings: 3000,
    upfrontCost: 200000,
  ...
  },
  {
    ...
    category: "transport",
    description:
      "Walk instead of driving for very short trips — free and healthy",
    icon: "🚶",
    carbonSavedKg: 15,
    monthlySavings: 500,
    upfrontCost: 0,
  ...
  // ── DIET (7 actions) ─────────────────────────────────────
  {
    ...
    category: "diet",
    description:
      "Go vegetarian one day per week to reduce food-related emissions",
    icon: "🥗",
    carbonSavedKg: 20,
    monthlySavings: 500,
    upfrontCost: 0,
  ...
  },
  {
    ...
    category: "diet",
    description:
      "Shop at local farmers markets — reduces transport emissions and supports farmers",
    icon: "🏪",
    carbonSavedKg: 15,
    monthlySavings: 400,
    upfrontCost: 0,
  ...
  },
  {
    ...
    category: "diet",
    description:
      "Grow basic herbs, spinach, and greens in pots on your balcony or garden",
    icon: "🌱",
    carbonSavedKg: 5,
    monthlySavings: 300,
    upfrontCost: 500,
  ...
  },
  {
    ...
    category: "diet",
    description:
      "Replace dairy milk with soy, oat, or almond milk for some uses",
    icon: "🥛",
    carbonSavedKg: 10,
    monthlySavings: 0,
    upfrontCost: 0,
  ...
  },
  {
    ...
    category: "diet",
    description:
      "Use a reusable bottle to avoid single-use plastic water bottles",
    icon: "🫗",
    carbonSavedKg: 3,
    monthlySavings: 200,
    upfrontCost: 500,
  ...
  // ── WASTE (4 actions) ────────────────────────────────────
  {
    ...
    category: "waste",
    description:
      "Compost vegetable peels, coffee grounds, and food scraps at home",
    icon: "🪱",
    carbonSavedKg: 20,
    monthlySavings: 300,
    upfrontCost: 2000,
  ...
  },
  {
    ...
    category: "waste",
    description:
      "Separate dry, wet, and hazardous waste at source for proper recycling",
    icon: "♻️",
    carbonSavedKg: 15,
    monthlySavings: 100,
    upfrontCost: 500,
  ...
  },
  {
    ...
    category: "waste",
    description:
      "Replace single-use plastic bags with cloth bags for all shopping",
    icon: "🛍️",
    carbonSavedKg: 5,
    monthlySavings: 100,
    upfrontCost: 300,
  ...
  },
  {
    ...
    category: "waste",
    description:
      "Replace disposable items with bamboo toothbrush, steel straws, cloth napkins",
    icon: "🎋",
    carbonSavedKg: 8,
    monthlySavings: 200,
    upfrontCost: 1000,
  ...
  // ── TREE PLANTING (4 actions) ────────────────────────────
  {
    ...
    description:
      "Plant a native tree species in your garden or society compound",
    icon: "🌳",
    carbonSavedKg: 22,
    monthlySavings: 0,
    upfrontCost: 200,
  ...
  },
  {
    ...
    category: "tree_planting",
    description:
      "Participate in local tree planting events and plantation drives",
    icon: "🤝",
    carbonSavedKg: 22,
    monthlySavings: 0,
    upfrontCost: 0,
  ...
  },
  {
    ...
    category: "tree_planting",
    description:
      "Grow vegetables, fruits, and medicinal plants in your garden or terrace",
    icon: "🪴",
    carbonSavedKg: 10,
    monthlySavings: 500,
    upfrontCost: 2000,
...
export const seedActionsIfEmpty = async (): Promise<void> => {
  ...
  console.log(
    "[EcoPlan] Seeding action database with",
...
export const calculateTreeDebt = (
  profile: LifestyleInput,
): { annualCO2: number; treesNeeded: number } => {
  let annualCO2 = 0;
  ...
  annualCO2 +=
    (wasteFactors[profile.wasteRecycling] || 100) * profile.householdSize;
...
const scoreAction = (action: any, profile: LifestyleInput): number => {
  ...
  if (action.monthlySavings > 0) {
    const savingsPercent =
      (action.monthlySavings / Math.max(profile.monthlyGroceryBill, 1000)) *
      100;
  ...
  if (
    ...
    action.name.toLowerCase().includes("ac")
  ) {
...
const PHASE_CONFIG = [
  {
    ...
    label: "Quick Wins",
    months: "Month 1-2",
    description: "Easy changes you can start today with zero or minimal cost",
  },
  {
    phase: "short_term",
    label: "Building Habits",
    months: "Month 3-6",
    description: "Sustainable changes that become second nature over time",
  },
  {
    phase: "medium_term",
    label: "Growing Impact",
    months: "Month 7-9",
    description: "Bigger investments that pay back significantly",
  },
  {
    phase: "long_term",
    label: "Full Transformation",
    months: "Month 10-12",
    description: "Major lifestyle upgrades for maximum long-term impact",
  },
];
...
export const generatePlan = async (
  ...
  const phases: PhasePlan[] = PHASE_CONFIG.map((config) => {
    ...
    const treesReduced = phaseActions.reduce(
      (sum, a) => sum + a.treesEquivalent,
      0,
    );
    const monthlySavings = phaseActions.reduce(
  ...
  const totalMonthlySavings = selectedActions.reduce(
    (s, a) => s + a.monthlySavings,
    0,
  );
  const totalUpfrontCost = selectedActions.reduce(
    (s, a) => s + a.upfrontCost,
    0,
  );
  const totalCO2Reduced = selectedActions.reduce(
    (s, a) => s + a.carbonSavedKg * 12,
    0,
  ); // annual
  const treesReducedByActions =
    Math.round((totalCO2Reduced / CO2_PER_TREE_PER_YEAR) * 100) / 100;
  const treesRemaining = Math.max(
    0,
    Math.round((treesNeeded - treesReducedByActions) * 100) / 100,
  );
  ...
  if (
    selectedActions.some(
      (a) =>
        a.category === "transport" && a.name.toLowerCase().includes("walk"),
    )
  ) {
  ...
  if (
    selectedActions.some(
      (a) =>
        a.category === "transport" && a.name.toLowerCase().includes("cycle"),
    )
  ) {
 ...
 */
export const saveLifestyleProfile = async (
  userId: string,
  data: LifestyleInput,
) => {
...
export const generateAndSavePlan = async (
  ...
  if (existingPlan) {
    await prisma.userPlanAction.deleteMany({
      where: { planId: existingPlan.id },
    });
  ...
  return {
    plan: { ...savedPlan, planData: plan },
    actions: allPlanActions,
    isExisting: false,
  };
};
...
export const getImpactSummary = async (userId: string) => {
  ...
  const co2Saved = completedActions.reduce(
    (sum, a) => sum + a.action.carbonSavedKg * 12,
    0,
  );
  const moneySaved = completedActions.reduce(
    (sum, a) => sum + a.action.monthlySavings,
    0,
  );
  const treesOffset = completedActions.reduce(
    (sum, a) => sum + a.action.treesEquivalent,
    0,
  );
  ...
  if (completedActions.length >= 1)
    milestones.push({ name: "First Step", icon: "🌱", achieved: true });
  if (completedActions.length >= 5)
    milestones.push({ name: "Eco Starter", icon: "🌿", achieved: true });
  if (completedActions.length >= 10)
    milestones.push({ name: "Green Warrior", icon: "🌳", achieved: true });
  if (plan.completionPercent >= 50)
    milestones.push({ name: "Halfway Hero", icon: "⭐", achieved: true });
  if (plan.completionPercent >= 100)
    milestones.push({ name: "Eco Champion", icon: "🏆", achieved: true });

  // Add unachieved upcoming milestones
  if (completedActions.length < 5)
    milestones.push({ name: "Eco Starter", icon: "🌿", achieved: false });
  if (completedActions.length < 10)
    milestones.push({ name: "Green Warrior", icon: "🌳", achieved: false });
  if (plan.completionPercent < 50)
    milestones.push({ name: "Halfway Hero", icon: "⭐", achieved: false });
