...
export const createPlantationEventSchema = z.object({
    ...
    boundary: z.array(z.array(z.number()).length(2)).min(4, 'Polygon must have at least 4 points (closed ring)'),
});
...
export type CreatePlantationEventInput = z.infer<typeof createPlantationEventSchema>;
