...
export const Events = ({ onBack, onNavigate }: any) => {
  ...
  const handleVerifyPresence = async (eventId: string) => {
    ...
    try {
      ...
      if (result.verified) {
        Alert.alert(
          ...
          result.message +
            (result.data?.rewards
              ? `\n\n+${result.data.rewards.ecoScoreEarned} Eco Score\n-${result.data.rewards.carbonOffset} kg CO₂ Debt`
              : ""),
        );
        fetchEvents();
      } else {
  ...
  const handleCreateEvent = async () => {
    ...
    if (
      ...
      Alert.alert(
        "Missing Fields",
        "Please fill in all required fields (title, description, date, time, location).",
      );
      return;
    }
    ...
    const lng = parseFloat(form.lng) || 77.209;
    ...
    try {
      ...
      Alert.alert(
        "Event Created! 🎉",
        result.message || "Your event is now live!",
      );
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.tabContainer}>
          ...
          >
            <Text
              style={
                activeTab === "hosting" ? styles.activeTabText : styles.tabText
              }
            >
              Your Hosting
            </Text>
          ...
          <View style={styles.createContent}>
            <View>
              ...
              <Text style={styles.createSubtitle}>
                Host your own cleanup or planting event
              </Text>
            </View>
            <TouchableOpacity
              ...
              <View style={styles.modalHeader}>
                <View>
                  ...
                  <Text style={styles.modalSubtitle}>
                    Create a cleanup or planting drive
                  </Text>
                </View>
                <TouchableOpacity
