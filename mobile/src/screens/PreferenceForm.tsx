        ...
        return (
          <View>
            ...
            <TextInput
              ...
              onChangeText={(v) =>
                updateForm("commuteDistance", parseFloat(v) || 0)
              }
        ...
        return (
          <View>
            ...
            <TextInput
              ...
              placeholder="e.g. 200"
              value={
                form.monthlyElectricity ? String(form.monthlyElectricity) : ""
              }
              onChangeText={(v) =>
                updateForm("monthlyElectricity", parseFloat(v) || 0)
              }
              keyboardType="numeric"
              style={styles.input}
              outlineColor="transparent"
            ...
            <TextInput
              ...
              onChangeText={(v) =>
                updateForm("acUsageHours", parseFloat(v) || 0)
              }
              keyboardType="numeric"
              style={styles.input}
              outlineColor="transparent"
            ...
            <View style={styles.counterRow}>
              <TouchableOpacity
                ...
                onPress={() =>
                  updateForm(
                    "householdSize",
                    Math.max(1, form.householdSize - 1),
                  )
                }
              >
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  updateForm(
                    "householdSize",
                    Math.min(20, form.householdSize + 1),
                  )
                }
              >
                <Text style={styles.counterBtnText}>+</Text>
        ...
        return (
          <View>
                ...
                <View style={styles.counterRow}>
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      updateForm(
                        "meatMealsPerWeek",
                        Math.max(0, form.meatMealsPerWeek - 1),
                      )
                    }
                  >
                    <Text style={styles.counterBtnText}>−</Text>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      updateForm(
                        "meatMealsPerWeek",
                        Math.min(21, form.meatMealsPerWeek + 1),
                      )
                    }
                  >
                    <Text style={styles.counterBtnText}>+</Text>
            ...
            <TextInput
              ...
              value={
                form.monthlyGroceryBill ? String(form.monthlyGroceryBill) : ""
              }
              onChangeText={(v) =>
                updateForm("monthlyGroceryBill", parseFloat(v) || 0)
              }
              keyboardType="numeric"
              style={styles.input}
              outlineColor="transparent"
          ...
          <View>
            ...
            <View style={styles.optionsRow}>
              <TouchableOpacity
                style={[
                  styles.optionBtn,
                  form.hasGarden && styles.optionBtnActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.optionText,
                    form.hasGarden && styles.optionTextActive,
                  ]}
                >
                  Yes 🌿
                </Text>
            ...
            <View key={i} style={styles.progressItem}>
              ...
              >
                {i < step ? (
                  ...
                  <Text
                    style={[styles.progressNum, i <= step && { color: "#fff" }]}
                  >
                    {i + 1}
                  </Text>
                )}
