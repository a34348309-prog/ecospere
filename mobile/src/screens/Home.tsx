...
export const Home = ({ onNavigate }: any) => {
    ...
    const oxygenPercent = treesPlanted > 0 ? Math.min(100, Math.round((treesPlanted / 200) * 100)) : 0;
        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.header}>
                <View style={styles.headerTextContainer}>
                    <Text style={styles.greeting}>Welcome back, {user?.name?.split(' ')[0] || 'Eco Warrior'}!</Text>
            ...
            >
                <View style={styles.levelHeader}>
                    ...
                    <Text style={styles.levelXp}>{xpCurrent} / {xpMax} XP</Text>
                </View>
            ...
            <LinearGradient
                ...
                style={styles.oxygenCard}
            >
                <View style={styles.oxygenHeader}>
                    <Leaf size={20} color={Colors.primary} />
                    <Text style={styles.oxygenTitle}>Oxygen Contribution</Text>
                </View>
                <Text style={styles.oxygenSubtitle}>Your positive impact on the environment</Text>

                <Text style={styles.oxygenPercent}>{oxygenPercent}%</Text>
                <Text style={styles.oxygenNote}>Trees planted contribute to cleaner air</Text>
...
const styles = StyleSheet.create({
    ...
    progressBarBg: { height: 8, backgroundColor: '#fff', borderRadius: 4, overflow: 'hidden' },
    ...
    oxygenHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
    oxygenTitle: { fontSize: 16, fontWeight: '800', color: '#006064' },
    oxygenSubtitle: { fontSize: 13, color: '#455A64', textAlign: 'center', marginBottom: 20 },
    oxygenPercent: { fontSize: 56, fontWeight: '900', color: Colors.primary, lineHeight: 60 },
    oxygenNote: { fontSize: 13, color: '#455A64', textAlign: 'center', marginTop: 8, marginBottom: 24 },
    ...
    streakBadge: { backgroundColor: '#B3E5FC', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12 },
    streakText: { fontSize: 11, fontWeight: '700', color: '#0277BD' },
    challengeItem: { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
    challengeNumCircle: { width: 28, height: 28, borderRadius: 14, backgroundColor: '#B3E5FC', justifyContent: 'center', alignItems: 'center', marginRight: 12 },
    ...
    xpBadge: { backgroundColor: '#fff', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8, borderWidth: 1, borderColor: Colors.primary },
